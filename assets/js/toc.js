...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!tocContainer || !content) {
        // This check is important. If you see this in your browser console,
        // it means the script can't find the required IDs in your HTML.
        console.warn('TOC container or main content not found. TOC will not be generated.');
        return;
    }

    // Find all header tags (h2, h3) within the main content. We skip h1 as it's the post title.
    ...
    headers.forEach(header => {
        ...
        if (header.tagName === 'H2') {
            // H2 links are less indented
            listItem.className = 'pl-2';
        } else if (header.tagName === 'H3') {
            // H3 links are more indented
